...
const UI_ANIMATION_SECONDS CLICK_DOWN_DURATION = 0.35;
const UI_ANIMATION_SECONDS CLICK_UP_DURATION = 0.8;
...
const DOUBLE CLICK_HANDLE_RADIUS = 11;
...
const FLOAT CLICK_GRADIENT_WIDTH = 10;
