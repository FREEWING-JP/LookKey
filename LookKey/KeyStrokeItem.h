...
const int RIGHT_GRADIENT_WIDTH = 180;
...
const UI_ANIMATION_SECONDS HOLD_DURATION = 1.8;
const UI_ANIMATION_SECONDS OUTRO_DURATION = 0.3;

const DOUBLE BOX_HEIGHT = 24.0;
const DOUBLE BOX_PADDING = 8.0;
const FLOAT BOX_BORDER = 1.2f;
const FLOAT BOX_CORNER_RADIUS = 0.0f;
...
const D2D1_COLOR_F BOX_BORDER_COLOR = D2D1::ColorF(0.9f, 0.9f, 0.9f, 1.0f);
